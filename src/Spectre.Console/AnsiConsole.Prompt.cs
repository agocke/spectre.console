...
public static partial class AnsiConsole
{
    ...
    /// <returns>The prompt input result.</returns>
    public static T Ask<[DynamicallyAccessedMembers(TypeConverterHelper.ConverterAnnotation)] T>(string prompt)
    {
    ...
    /// <returns>The prompt input result.</returns>
    public static T Ask<[DynamicallyAccessedMembers(TypeConverterHelper.ConverterAnnotation)] T>(string prompt, T defaultValue)
    {
