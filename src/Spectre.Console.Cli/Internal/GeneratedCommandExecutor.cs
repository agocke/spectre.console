...
internal sealed class GeneratedCommandExecutor
{
    private readonly ITypeRegistrar _registrar;

    public GeneratedCommandExecutor(ITypeRegistrar registrar)
    {
    ...
    public async Task<int> Execute(IConfiguration configuration, IEnumerable<string> args)
    {
        ...
        var model = CommandModelBuilder.BuildSafe(configuration);
...
#pragma warning restore CS8603 // Possible null reference return.
        ...
        IConfiguration configuration)
    {
        ...
        var settings = GeneratedCommandBinder.Bind(tree, leaf.Command.SettingsType, resolver);
